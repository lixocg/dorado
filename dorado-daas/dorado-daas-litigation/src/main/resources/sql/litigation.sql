...
(
  ...
  simple_case_number character varying(255), -- 简单案号，用于判重
...
COMMENT ON COLUMN public.litigation_parsed_data_detail.simple_case_number IS '简单案号，用于判重';
COMMENT ON COLUMN public.litigation_parsed_data_detail.simple_previous_case_number IS '简单上期案号';
...
-- Index: public.litigation_parsed_data_detail_court_id_idx

-- DROP INDEX public.litigation_parsed_data_detail_court_id_idx;

CREATE INDEX litigation_parsed_data_detail_court_id_idx
  ON public.litigation_parsed_data_detail
  USING btree
  (court_id);
...
-- Index: public.litigation_parsed_data_detail_simple_case_number_idx

-- DROP INDEX public.litigation_parsed_data_detail_simple_case_number_idx;

CREATE INDEX litigation_parsed_data_detail_simple_case_number_idx
  ON public.litigation_parsed_data_detail
  USING btree
  (simple_case_number COLLATE pg_catalog."default");
