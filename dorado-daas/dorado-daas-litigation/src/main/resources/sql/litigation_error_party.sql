...
Date: 2017-01-16 17:02:38
*/

SET FOREIGN_KEY_CHECKS=0;

-- ----------------------------
-- Table structure for litigation_error_party
-- ----------------------------
DROP TABLE IF EXISTS `litigation_error_party`;
CREATE TABLE `litigation_error_party` (
  `id` varchar(65) NOT NULL COMMENT '主键',
  `supplier_id` char(65) DEFAULT NULL COMMENT '供应商主键',
