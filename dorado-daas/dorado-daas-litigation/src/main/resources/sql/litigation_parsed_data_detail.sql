...
Date: 2017-01-16 16:42:55
*/

SET FOREIGN_KEY_CHECKS=0;

-- ----------------------------
-- Table structure for litigation_parsed_data_detail
-- ----------------------------
DROP TABLE IF EXISTS `litigation_parsed_data_detail`;
CREATE TABLE `litigation_parsed_data_detail` (
