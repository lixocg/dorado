...
public class LitigationServiceTest {
	...
	public void transmitCorpLitigationTest() throws InterruptedException {
		...
		logger.info("诉讼主表记录数:>>>>>>>>>>" + litigationTransitService.getCorpLitigationCount(d));
		litigationTransitService.transmitCorpLitigation(4, 50, d);
	...
	public void transmitCorpLitigationHistoryTest() {
		logger.info("诉讼进程表记录数:>>>>>>>>>>" + litigationTransitService.getLitigationHistroyCount(d));
		litigationTransitService.transmitCorpLitigationHistory(1, 1, d);
	}
	...
	public void transmitSqlserverCorpLitigationTest() {
		logger.info("诉讼平台记录数:>>>>>>>>>>" + litigationTransitService.getSqlserverCorpLitigationCount(d));
		litigationTransitService.transmitSqlserverCorpLitigation(1, 1, d);
	}

	@Test
	public void testDudeplicate() {
		LitigationAPIPojo pojo = litigationAdapterService.getAPiPojoById("E15728645", 0,
	...
	public void doDeplicate() throws Exception {
		while (true) {
			List<LitigationAPIPojo> lastestPojos = litigationAdapterService.getLastest(100, 0,
					LitiBusiConstant.ParsedStatus.SUCCESS);
	...
	@Test
	public void api() {
		LitigationAPIPojo litigation = litigationAdapterService.getAPiPojoById("E4477539", 0, 0);
		String s = litigationToMonitorService.transLitigationTo(litigation);
