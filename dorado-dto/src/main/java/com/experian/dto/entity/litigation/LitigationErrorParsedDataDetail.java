...
/**
 * 映射表： litigation_error_parsed_data_detail
 */
public class LitigationErrorParsedDataDetail implements Serializable {
    /**
     * 主键
     * 映射字段： id
     */
    ...
    public boolean equals(Object that) {
        ...
        LitigationErrorParsedDataDetail other = (LitigationErrorParsedDataDetail) that;
