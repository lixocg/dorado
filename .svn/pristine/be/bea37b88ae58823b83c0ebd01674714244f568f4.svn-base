...
/**
 * 映射表： litigation_temp_crawled_data
 */
public class LitigationTempCrawledData implements Serializable {
    /**
     * 主键
     * 映射字段： id
     */
    ...
    public boolean equals(Object that) {
        ...
        LitigationTempCrawledData other = (LitigationTempCrawledData) that;
