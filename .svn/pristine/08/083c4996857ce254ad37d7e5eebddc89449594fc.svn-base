...
Date: 2017-01-16 16:43:17
*/

SET FOREIGN_KEY_CHECKS=0;

-- ----------------------------
-- Table structure for litigation_temp_crawled_data
-- ----------------------------
DROP TABLE IF EXISTS `litigation_temp_crawled_data`;
CREATE TABLE `litigation_temp_crawled_data` (
