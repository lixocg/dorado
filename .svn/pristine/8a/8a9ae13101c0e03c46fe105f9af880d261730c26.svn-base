...
Date: 2017-01-16 16:43:28
*/

SET FOREIGN_KEY_CHECKS=0;

-- ----------------------------
-- Table structure for litigation_temp_party
-- ----------------------------
DROP TABLE IF EXISTS `litigation_temp_party`;
CREATE TABLE `litigation_temp_party` (
  `id` varchar(65) NOT NULL COMMENT '主键',
  `supplier_id` char(65) NOT NULL COMMENT '供应商主键',
