...
Date: 2017-01-16 16:43:22
*/

SET FOREIGN_KEY_CHECKS=0;

-- ----------------------------
-- Table structure for litigation_temp_parsed_data_detail
-- ----------------------------
DROP TABLE IF EXISTS `litigation_temp_parsed_data_detail`;
CREATE TABLE `litigation_temp_parsed_data_detail` (
  ...
  `fetch_flag` int(1) DEFAULT NULL COMMENT '数据提取标示，0-未被提取过，1-已被提取',
  PRIMARY KEY (`id`)
